            ...
            <table id="datoTable" align="center">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" name="sfields[]" id="sfieldst" value="title" <?php if(isset($_POST['sfields']) && is_array($_POST['sfields']) && in_array('title', $_POST['sfields'])) echo 'checked="checked"'; ?> />Name
